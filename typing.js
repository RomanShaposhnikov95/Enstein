...
!(function (D, u) {
    ...
    function splitInnerHTML(D, u, F, C) {
        for (var E, e = D.firstChild, t = []; e; )
            3 === e.nodeType
                ? ((E = (e.nodeValue + "").replace(/^\n+/g, "")), C || (E = E.replace(/\s+/g, " ")), t.push.apply(t, emojiSafeSplit(E, u, F, C)))
    ...
    function emojiSafeSplit(D, u, F, C) {
        ...
        for (var E, e, t = [], n = D.length, B = 0; B < n; B++)
            ((55296 <= (e = D.charAt(B)).charCodeAt(0) && e.charCodeAt(0) <= 56319) || (65024 <= D.charCodeAt(B + 1) && D.charCodeAt(B + 1) <= 65039)) &&
                ((E = ((D.substr(B, 12).split(A) || [])[1] || "").length || 2), (e = D.substr(B, E)), (B += E - (t.emoji = 1))),
        ...
        F = {
            ...
            init: function init(D, u, F) {
                ...
                if (((s.target = D), "value" in u)) {
                    ...
                    u.speed && F.duration(Math.min((0.05 / u.speed) * C.length, u.maxDuration || 9999)), (s.rtl = p), (s.original = e), (s.text = E), s._props.push("text");
            ...
            render: function render(D, u) {
                ...
                (E =
                    t && D
                        ? ((C = B && a !== o), ((F = n && a) ? "<span class='" + n + "'>" : "") + e.slice(0, a).join(i) + (F ? "</span>" : "") + (C ? "<span class='" + B + "'>" : "") + i + s.slice(a).join(i) + (C ? "</span>" : ""))
